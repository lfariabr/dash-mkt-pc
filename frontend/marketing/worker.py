...
from frontend.sales.sale_columns import colunas_reduzido
from frontend.sales.sales_cleaner import filter_relevant_sales_to_mkt
from frontend.leads.leads_cleaner import filter_relevant_leads_to_mkt
