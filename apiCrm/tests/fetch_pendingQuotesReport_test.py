...
from apiCrm.resolvers.fetch_pendingQuotesReport import fetch_and_process_pendingQuotes_report
...
async def main():
    ...
    pending_quotes = await fetch_and_process_pendingQuotes_report(start_date, end_date)
