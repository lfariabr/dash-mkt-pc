...
async def fetch_leadsByUserReportTest(session, start_date: str, end_date: str) -> List[Dict]:
    """
...
async def fetch_and_process_leadsByUserReportTest(start_date: str, end_date: str) -> List[Dict]:
    """
    ...
    async with aiohttp.ClientSession() as session:
        leadsByUserReport = await fetch_leadsByUserReportTest(session, start_date, end_date)
